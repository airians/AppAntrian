      ...
      <div class="content-wrapper">
        ...
        $cari_kd=mysqli_query($konek, "select max(id_pendaftaran)as kode from tbl_historydaftar"); //mencari kode yang paling besar atau kode yang baru masuk
                  ...
                  <div class="input-group">
                    <div class="input-group-addon">
                      <i class="fa fa-id-card"></i>
                                 ...
                                 ";
                                 $jsArray2 = "var polisName = new Array(); 
                                 ";
                                 ...
                                 <select name="counter" class="form-control" onchange="document.getElementById('dkt_name').value = dktName[this.value],document.getElementById('polis_name').value = polisName[this.value]">
                                 ...
                                 while ($row = mysqli_fetch_array($result)) {
                                   ...
                                   $jsArray2 .= "polisName['" . $row['id_ruangan'] . "'] = '" . addslashes($row['nama_polis']) . "';
                                   ";
                                      }
