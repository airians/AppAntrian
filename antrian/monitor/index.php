    ...
    <div class="container">
	    ...
	    <div class="audio">
			...
			<audio id="loket" src="../audio/new/loket.MP3"></audio>
       				...
       				<div class="col-xs-4">
						<center><h3>Dr. Nabilah Abdurrahman</h3></center>
					</div>
      				<div class="col-xs-4">
						<center><h3>drg. Atikah Bahar</h3></center>
					</div>
      				<div class="col-xs-4">
						<center><h3>drg. Ari Arifin</h3></center>
					</div>
       	</div>
       	<br>
       	<br>
						...
						loket = '<div class="col-lg-4">'+
									'<div class="'+ i +
									 ' jumbotron" style="padding-top:20px;padding-bottom:20px;">'+
										...
										'<button class="btn btn-danger" type="button"><span class="glyphicon glyphicon-credit-card">&nbsp;</span>RUANGAN ' + i +' </button>'+
									'</div>'+
								'</div>';
						$(".loket").append(loket);
					}
